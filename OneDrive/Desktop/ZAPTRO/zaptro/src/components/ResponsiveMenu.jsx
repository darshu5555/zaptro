import { UserButton, useUser,Show, SignUpButton } from '@clerk/react'
        ...
        {!user && (
          <div className='mt-8 md:hidden'>
            <SignUpButton
              ...
              className="bg-red-500 text-white px-3 py-1 rounded-md cursor-pointer w-full"
            />
            <Show when="signed-in">
          <UserButton  className="bg-red-500 text-white px-3 py-1 rounded-md cursor-pointer"/>
        </Show>
          </div>
        )}
      </div>
