  ...
  return (
...

   {
    SingleProduct ? <div className='px-4 pb-4 md:px-0 '>
      ...
      <div className='max-w-6xl max-auto md:p-6 grid grid-cols-1 md:grid-cols-2 gap-10'>
        ...
        <div className='flex flex-col gap-6'>
          ...
          <div className='text-gray-700'>{SingleProduct.brand?.toUpperCase()} /{SingleProduct.category?.toUpperCase()} /{SingleProduct.sku}</div>
          <p className='text-xl text-red-500 font-bold'>${SingleProduct.price.toFixed(0)} <span className='line-through text-gray-700'>  ${OriginalPrice}</span> <span className='bg-red-500 text-white px-4 py-2 rounded-full'>  {SingleProduct.discountPercentage.toFixed(0)
}% discount</span></p>
